...
public class TDItems {
	...
	public static final ItemEntry<KnifeItem> FIERY_KNIFE;
	public static final ItemEntry<KnifeItem> IRONWOOD_KNIFE;
	public static final ItemEntry<KnifeItem> STEELEAF_KNIFE;
	public static final ItemEntry<KnifeItem> KNIGHTLY_KNIFE;
	public static final ItemEntry<SwordItem> TEARDROP_SWORD;
	...
	public enum FoodType {
		NONE(Rarity.COMMON, false, false, false, Item::new),
		MEAT(Rarity.COMMON, true, false, false, Item::new),
		COOKIE(Rarity.COMMON, false, true, false, Item::new),
		UNCOMMON_MEAT(Rarity.UNCOMMON, true, false, false, Item::new),
		...
		BOWL_ONE(Rarity.COMMON, false, false, false, p -> new InBowlItem(p.stacksTo(1))),
	...
	public enum Food {
		...
		GLOWSTEW(FoodType.BOWL_ONE, 7, 0.675F,
				new EffectSupplier(() -> MobEffects.GLOWING, 200, 0, 1),
				new EffectSupplier(ModEffects.COMFORT, 1200, 1, 1)),
		GLOW_VENISON_RIB_WITH_PASTA(FoodType.BOWL_MEAT, 12, 0.7f,
				new EffectSupplier(() -> MobEffects.GLOWING, 200, 0, 1),
				new EffectSupplier(ModEffects.NOURISHMENT, 6000, 1, 1)),
		...
		PLATE_OF_FIERY_SNAKES(FoodType.BOWL_MEAT, 20, 1.9f,
				new EffectSupplier(ModEffects.NOURISHMENT, 12000, 1, 1),
				new EffectSupplier(ModEffects.COMFORT, 6000, 1, 1),
	...
	static {
		...
		KNIGHTLY_KNIFE = handheld("knightmetal_knife", p -> new TDKnifeItem(TwilightItemTier.KNIGHTMETAL, p));
		TEARDROP_SWORD = handheld("teardrop_sword", TeardropSword::new);
	}
	...
	private static <T extends Item> ItemEntry<T> handheld(String id, NonNullFunction<Item.Properties, T> factory) {
		return TwilightDelight.REGISTRATE.item(id, factory).model((ctx, pvd) -> pvd.handheld(ctx)).register();
	}

	public static class Tab extends CreativeModeTab {

		public Tab(String label) {
			super(TwilightDelight.MODID + "." + label);
		}
