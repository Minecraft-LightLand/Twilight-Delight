...
public enum DelightFood {
	...
	RAW_VENISON_RIB(DelightFoodType.FAST, 2, 0.7f),
	COOKED_VENISON_RIB(DelightFoodType.FAST, 4, 0.8f),
	RAW_MEEF_SLICE(DelightFoodType.FAST, 1, 0.7F),
	COOKED_MEEF_SLICE(DelightFoodType.FAST, 3, 0.8F),
	RAW_TOMAHAWK_SMEAK(DelightFoodType.NONE, 6, 0.7F),
	COOKED_TOMAHAWK_SMEAK(DelightFoodType.NONE, 12, 0.8F),
	RAW_INSECT(DelightFoodType.NONE, 2, 0.2F),
	COOKED_INSECT(DelightFoodType.NONE, 6, 0.6F),
	TORCHBERRY_COOKIE(DelightFoodType.FAST, 2, 0.2F,
			new EffectSupplier(MobEffects.GLOWING, 200, 0, 1),
			new EffectSupplier(TDEffects.FIRE_RANGE, 200, 0, 0.3f)),
	NAGA_CHIP(DelightFoodType.FAST, 2, 0.8F,
	...
	MEEF_WRAP(DelightFoodType.NONE, 10, 0.8f,
	...
	HYDRA_BURGER(DelightFoodType.NONE, 18, 0.8f,
	...
	MUSHGLOOM_SAUCE(DelightFoodType.SAUCE, 5, 0.4f,
			new EffectSupplier(MobEffects.GLOWING, 200, 0, 1)),
	GLOW_VENISON_RIB_WITH_PASTA(DelightFoodType.BOWL, 12, 0.8f,
			new EffectSupplier(MobEffects.GLOWING, 200, 0, 1),
			new EffectSupplier(MobEffects.DAMAGE_RESISTANCE, 1800, 1, 1),
			new EffectSupplier(ModEffects.NOURISHMENT, 3600, 0, 1)),
	MUSHGLOOM_MEEF_PASTA(DelightFoodType.BOWL, 12, 0.8f,
			new EffectSupplier(MobEffects.GLOWING, 100, 0, 1),
			new EffectSupplier(MobEffects.DAMAGE_BOOST, 1200, 1, 1),
			new EffectSupplier(MobEffects.REGENERATION, 1200, 1, 1),
			new EffectSupplier(ModEffects.NOURISHMENT, 3600, 0, 1)),
	LIVEROOT_PORK_FRIED_RICE(DelightFoodType.BOWL, 12, 0.8f,
			new EffectSupplier(MobEffects.DAMAGE_RESISTANCE, 3600, 0, 1),
			new EffectSupplier(ModEffects.NOURISHMENT, 3600, 0, 1)),
	LIVEROOT_VENISON_NOODLE_SOUP(DelightFoodType.BOWL, 10, 0.8f,
			new EffectSupplier(MobEffects.DAMAGE_RESISTANCE, 1200, 1, 1),
			new EffectSupplier(ModEffects.COMFORT, 3600, 0, 1)),
	TORCHBERRY_VENISON_SANDWICH(DelightFoodType.NONE, 10, 0.8f,
	...
	THOUSAND_PLANT_STEW(DelightFoodType.BOWL, 10, 0.6f,
			...
			new EffectSupplier(ModEffects.COMFORT, 1200, 0, 1)),
	GRILLED_GHAST(DelightFoodType.BOWL, 10, 0.8f,
			new EffectSupplier(ModEffects.NOURISHMENT, 6000, 0, 1),
			new EffectSupplier(MobEffects.REGENERATION, 6000, 1, 1),
			new EffectSupplier(MobEffects.FIRE_RESISTANCE, 6000, 0, 1)),
	GRILLED_TOMAHAWK_SMEAK(DelightFoodType.BOWL, 14, 0.8f,
			new EffectSupplier(ModEffects.NOURISHMENT, 6000, 0, 1),
	...
	PLATE_OF_LILY_CHICKEN(DelightFoodType.BOWL, 16, 0.9f,
			new EffectSupplier(MobEffects.FIRE_RESISTANCE, 6000, 0, 1),
			new EffectSupplier(ModEffects.NOURISHMENT, 6000, 0, 1)),
	PLATE_OF_FIERY_SNAKES(DelightFoodType.BOWL, 20, 1.9f,
			new EffectSupplier(ModEffects.NOURISHMENT, 6000, 0, 1),
			new EffectSupplier(ModEffects.COMFORT, 6000, 0, 1),
			new EffectSupplier(MobEffects.DAMAGE_BOOST, 6000, 2, 1),
			new EffectSupplier(MobEffects.REGENERATION, 6000, 1, 1)),
	PLATE_OF_MEEF_WELLINGTON(DelightFoodType.BOWL, 14, 0.8f,
