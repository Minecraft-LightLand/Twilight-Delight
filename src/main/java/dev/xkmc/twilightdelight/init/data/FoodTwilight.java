...
public class FoodTwilight extends ConfigDataProvider {

	public FoodTwilight(DataGenerator generator, CompletableFuture<HolderLookup.Provider> pvd) {
		super(generator, pvd, "Cuisine Twilight Compat");
	}
	...
	public void add(ConfigDataProvider.Collector map) {
		...
		if (ModList.get().isLoaded(TwilightForestMod.ID)) {
			map.add(CuisineDelight.INGREDIENT, ResourceLocation.fromNamespaceAndPath(TwilightForestMod.ID, "meat"), IngredientConfig.build(
			...
			map.add(CuisineDelight.INGREDIENT, ResourceLocation.fromNamespaceAndPath(TwilightForestMod.ID, "veges"), IngredientConfig.build(
			...
			map.add(CuisineDelight.TRANSFORM, ResourceLocation.fromNamespaceAndPath(TwilightForestMod.ID, "meat"), new CookTransformConfig()
		...
		if (ModList.get().isLoaded(TwilightDelight.MODID)) {
			map.add(CuisineDelight.INGREDIENT, ResourceLocation.fromNamespaceAndPath(TwilightDelight.MODID, "meat"), IngredientConfig.build(
					...
					IngredientConfig.get(Ingredient.of(DelightFood.EXPERIMENT_113.item.get()), FoodType.MEAT,
							...
							new IngredientConfig.EffectEntry(TDEffects.TEMPORAL_SADNESS, 0, 60)),
					IngredientConfig.get(Ingredient.of(DelightFood.EXPERIMENT_110.item.get()), FoodType.MEAT,
							...
							new IngredientConfig.EffectEntry(TDEffects.TEMPORAL_SADNESS, 0, 100)
					)
			));


			map.add(CuisineDelight.INGREDIENT, ResourceLocation.fromNamespaceAndPath(TwilightDelight.MODID, "veges"), IngredientConfig.build(
					IngredientConfig.get(Ingredient.of(TFItems.STEELEAF_INGOT.get()), FoodType.VEG,
							300, 360, 40, 0.5f, 0.5f, 1, 1,
							new IngredientConfig.EffectEntry(TDEffects.POISON_RANGE, 0, 1200)),
					IngredientConfig.get(Ingredient.of(TFItems.ICE_BOMB.get()), FoodType.NONE,
							0, 360, 40, 0.5f, 0.5f, 1, 1,
							new IngredientConfig.EffectEntry(TDEffects.FROZEN_RANGE, 0, 1200)),
					IngredientConfig.get(Ingredient.of(TFItems.FIERY_BLOOD.get(), TFItems.FIERY_TEARS.get()), FoodType.NONE,
							0, 360, 80, 0.5f, 0.5f, 1, 1,
							new IngredientConfig.EffectEntry(TDEffects.FIRE_RANGE, 0, 1200))
			));

			map.add(CuisineDelight.TRANSFORM, ResourceLocation.fromNamespaceAndPath(TwilightDelight.MODID, "meat"), new CookTransformConfig()
			...
			map.add(CuisineDelight.TRANSFORM, ResourceLocation.fromNamespaceAndPath(TwilightDelight.MODID, "fluids"), new CookTransformConfig()
